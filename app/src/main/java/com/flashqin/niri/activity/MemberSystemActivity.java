...
public class MemberSystemActivity extends BaseActivity {
    ...
    String[] strcontent1 = {" The registration bonus is ₦2000, but it can only be withdrawn if the member reaches Level 3 or above\n" +
            ...
            " The profit is 0.3% of each order amount\n" +
            " Members shall pay 14% of the withdrawal amount to the platform.\n", " Recharge ₦5000 to become a valid member\n" +
            " The profit is 0.35% of each order amount\n" +
            " Members shall pay 12% of the withdrawal amount to the platform.\n", " Recharge ₦10000 to become a valid member\n" +
            " The profit is 0.4% of each order amount\n" +
            " Members shall pay 13% of the withdrawal amount to the platform.\n", " Recharge ₦50000 to become a valid member\n" +
            " The profit is 0.45% of each order amount\n" +
            " Members shall pay 12% of the withdrawal amount to the platform.\n"+"You will receive a registration bonus of ₦2000", " Recharge ₦100000 to become a valid member\n" +
            " The profit is 0.5% of each order amount\n" +
            " Members shall pay 11% of the withdrawal amount to the platform.\n"," Recharge ₦300000 to become a valid member\n" +
