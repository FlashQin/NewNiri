...
public class GongziRecordActivity extends BaseActivity {
    ...
    public void initAdapter() {
        ...
        rec.setLayoutManager(new LinearLayoutManager(GongziRecordActivity.this));
        ...
        View inflate = LayoutInflater.from(GongziRecordActivity.this).inflate(R.layout.layout_empty_home2, null);
